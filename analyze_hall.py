...
1. 【熱い日のパターン】
   「〇のつく日」「月と日がゾロ目の日（1/1・2/2・3/3…）」のように、特定の日付ルールでまとめて説明してください。
   具体的な日付（4/28 など）は書かず、パターンで表現してください。
   「月と重なる日」や「ゾロ目の日」は必ず「月と日がゾロ目の日」と表現し、「5のつく日」などに言い換えないでください。
